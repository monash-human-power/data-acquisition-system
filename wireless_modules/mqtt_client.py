...
class Client:
    def __init__(self, client_id, broker_address, will_topic=None, will_msg=None):
        """
        ...
        if will_topic and will_msg:
            self.client.set_last_will(will_topic, self._to_bytes_literal(will_msg), retain=True)
